...
80106d0f:	8b 38                	mov    (%eax),%edi
80106d11:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106d16:	81 c7 ff 0f 00 00    	add    $0xfff,%edi
80106d1c:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
...
80106d31:	74 60                	je     80106d93 <shm_open+0xa3>
    //Case 1
...
80106d37:	8d 1c 5b             	lea    (%ebx,%ebx,2),%ebx
      struct proc *curproc = myproc();
80106d3a:	e8 71 c9 ff ff       	call   801036b0 <myproc>
      mappages(curproc->pgdir, (char *)currSz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106d3f:	c1 e3 02             	shl    $0x2,%ebx
80106d42:	8b 8b f8 54 11 80    	mov    -0x7feeab08(%ebx),%ecx
80106d48:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d4f:	00 
80106d50:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d57:	00 
80106d58:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106d5c:	8d 91 00 00 00 80    	lea    -0x80000000(%ecx),%edx
80106d62:	89 54 24 0c          	mov    %edx,0xc(%esp)
...
80106d7b:	89 38                	mov    %edi,(%eax)
  ...
  release(&(shm_table.lock));
80106d7d:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d84:	e8 b7 d4 ff ff       	call   80104240 <release>
  return 0;
}
80106d89:	83 c4 2c             	add    $0x2c,%esp
...
80106d92:	c3                   	ret    
  for (i = 0; i < 64; i++) {
80106d93:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106d98:	31 d2                	xor    %edx,%edx
80106d9a:	eb 0f                	jmp    80106dab <shm_open+0xbb>
80106d9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (i = 0; i < 64; i++) {
80106da0:	83 c2 01             	add    $0x1,%edx
80106da3:	83 c0 0c             	add    $0xc,%eax
80106da6:	83 fa 40             	cmp    $0x40,%edx
80106da9:	74 d2                	je     80106d7d <shm_open+0x8d>
      if ( (shm_table.shm_pages[i].id == 0) && (shm_table.shm_pages[i].frame == 0) && (shm_table.shm_pages[i].refcnt == 0) ) {
80106dab:	8b 08                	mov    (%eax),%ecx
80106dad:	85 c9                	test   %ecx,%ecx
80106daf:	75 ef                	jne    80106da0 <shm_open+0xb0>
80106db1:	8b 58 04             	mov    0x4(%eax),%ebx
80106db4:	85 db                	test   %ebx,%ebx
80106db6:	75 e8                	jne    80106da0 <shm_open+0xb0>
80106db8:	8b 48 08             	mov    0x8(%eax),%ecx
80106dbb:	85 c9                	test   %ecx,%ecx
80106dbd:	75 e1                	jne    80106da0 <shm_open+0xb0>
        shm_table.shm_pages[i].id = id;
80106dbf:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
80106dc2:	c1 e3 02             	shl    $0x2,%ebx
80106dc5:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
        shm_table.shm_pages[i].frame = kalloc();
80106dcb:	e8 e0 b6 ff ff       	call   801024b0 <kalloc>
        memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106dd0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dd7:	00 
80106dd8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ddf:	00 
...
80106dee:	c7 83 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%ebx)
80106df5:	00 00 00 
        mappages(myproc()->pgdir, (char*)currSz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106df8:	8b 9b f8 54 11 80    	mov    -0x7feeab08(%ebx),%ebx
80106dfe:	e8 ad c8 ff ff       	call   801036b0 <myproc>
80106e03:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0a:	00 
80106e0b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e12:	00 
80106e13:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106e19:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e1d:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106e21:	8b 40 04             	mov    0x4(%eax),%eax
80106e24:	89 04 24             	mov    %eax,(%esp)
80106e27:	e8 24 f7 ff ff       	call   80106550 <mappages>
        *pointer = (char *)currSz; 
80106e2c:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e2f:	89 38                	mov    %edi,(%eax)
        break;
80106e31:	e9 47 ff ff ff       	jmp    80106d7d <shm_open+0x8d>
...
80106e68:	74 2e                	je     80106e98 <shm_close+0x58>
    if (shm_table.shm_pages[i].id == id) {
80106e6a:	3b 18                	cmp    (%eax),%ebx
80106e6c:	75 f2                	jne    80106e60 <shm_close+0x20>
      shm_table.shm_pages[i].refcnt--;
80106e6e:	8b 48 08             	mov    0x8(%eax),%ecx
80106e71:	8d 51 ff             	lea    -0x1(%ecx),%edx
      if (shm_table.shm_pages[i].refcnt == 0) {
80106e74:	85 d2                	test   %edx,%edx
      shm_table.shm_pages[i].refcnt--;
80106e76:	89 50 08             	mov    %edx,0x8(%eax)
      if (shm_table.shm_pages[i].refcnt == 0) {
80106e79:	75 e5                	jne    80106e60 <shm_close+0x20>
        shm_table.shm_pages[i].id = 0;
80106e7b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e81:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].frame = 0;
80106e84:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
  for (i = 0; i < 64; i++) {
80106e8b:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e90:	75 d8                	jne    80106e6a <shm_close+0x2a>
80106e92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      }
    }
  }
  release(&(shm_table.lock));
80106e98:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e9f:	e8 9c d3 ff ff       	call   80104240 <release>
  return 0; 
}
80106ea4:	83 c4 14             	add    $0x14,%esp
